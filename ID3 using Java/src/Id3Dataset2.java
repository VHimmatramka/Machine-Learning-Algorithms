...
public class Id3Dataset2 {
	public static void main(String args[]) throws Exception{
		// Converting the Training dataset  1  From CSV format to ARFF 
		//ARFF - Attribute Relation File Format
		CSVLoader loader = new CSVLoader();
		loader.setSource(new File("C:\\Users\\Ankitha\\workspace\\DecisionTree\\Train2.csv"));
		Instances data = loader.getDataSet();
		
		ArffSaver saver = new ArffSaver();
		saver.setInstances(data);
		
		saver.setFile(new File("C:\\Users\\Ankitha\\workspace\\DecisionTree\\Train2.arff"));
		saver.writeBatch();
		
		// Converting the Testing dataset 1  From CSV format to ARFF 
		//ARFF - Attribute Relation File Format
		CSVLoader loader1 = new CSVLoader();
		loader1.setSource(new File("C:\\Users\\Ankitha\\workspace\\DecisionTree\\Test2.csv"));
		Instances data1 = loader1.getDataSet();
		
		ArffSaver saver1 = new ArffSaver();
		saver1.setInstances(data1);
		
		saver1.setFile(new File("C:\\Users\\Ankitha\\workspace\\DecisionTree\\Test2.arff"));
		saver1.writeBatch();
		
		//Converting the numeric data to Nominal data 
		
		DataSource source = new DataSource("C:\\Users\\Ankitha\\workspace\\DecisionTree\\Train2.arff");
		...
		saver2.setFile(new File("C:\\Users\\Ankitha\\workspace\\DecisionTree\\Train2Nominal.arff"));
		saver2.writeBatch();
		
		//Converting the numeric data to Nominal data 
		
		DataSource source1 = new DataSource("C:\\Users\\Ankitha\\workspace\\DecisionTree\\Test2.arff");
		...
		saver3.setFile(new File("C:\\Users\\Ankitha\\workspace\\DecisionTree\\Test2Nominal.arff"));
		saver3.writeBatch();
		
		
		DataSource sourceTrain = new DataSource("C:\\Users\\Ankitha\\workspace\\DecisionTree\\Train2Nominal.arff");
		...
		DataSource sourceTest = new DataSource("C:\\Users\\Ankitha\\workspace\\DecisionTree\\Test2Nominal.arff");
